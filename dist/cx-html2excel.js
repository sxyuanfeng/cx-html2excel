(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("html2excel", ["exceljs"], factory);
	else if(typeof exports === 'object')
		exports["html2excel"] = factory(require("exceljs"));
	else
		root["html2excel"] = factory(root["ExcelJS"]);
})(globalThis, (__WEBPACK_EXTERNAL_MODULE_exceljs__) => {
...
/***/ "exceljs":
/*!*****************************************************************************************************************!*\
  !*** external {"root":"ExcelJS","commonjs":"exceljs","commonjs2":"exceljs","amd":"exceljs","module":"exceljs"} ***!
  \*****************************************************************************************************************/
/***/ ((module) => {
...
function generateExcel(tables, userOptions) {
...
//# sourceMappingURL=cx-html2excel.js.map